...
<section class="relative overflow-hidden">
    ...
    @if($isFree)
        <div class="absolute inset-0 bg-surface-base/85 backdrop-blur-xs z-10 flex flex-col items-center justify-center text-center p-6 transition-all duration-300">
